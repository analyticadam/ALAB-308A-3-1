...
// or
// central(id).then((returnedValue3) => { ... });
...
// const returnedValue4 = await db1(id);
// console.log(returnedValue4);
// or
// db1(id).then((returnedValue5) => { ... });
...
// const returnedValue6 = await vault(id);
// or
// vault(id).then((returnedValue7) => { ... });
